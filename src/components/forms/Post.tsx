                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className='flex w-full flex-col'>
                            <FormLabel className='paragraph-semibold'>Title</FormLabel>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className='flex w-full flex-col gap-3'>
                            <FormLabel className='paragraph-semibold'>Detailed explanation of your
                                problem
                            </FormLabel>
                            <FormControl className='mt-3.5'>
                                <Editor
                                    ...
                                    {field.value.length > 0 && (
                                        <div className='flex-start mt-2.5 gap-2.5'>
                                            {field.value.map((tag: any) => (
                                                ...
                                                rounded-md border-none px-4 py-2
                                                capitalize' onClick={() =>
